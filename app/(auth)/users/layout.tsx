...
export default function TransactionsLayout({
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-background">
        <div className="container mx-auto">
          {/* Responsive flex: column on small, row on md+ */}
          <div className="flex flex-col md:flex-row gap-10 md:gap-30">
            ...
            {/* Main content stacked below on small, beside on md+ */}
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto">
        {/* Responsive flex: column on small, row on md+ */}
        <div className="flex flex-col sm:flex-row gap-10 sm:gap-20 md:gap-30">
          <div className="lg:w-80 shrink-0 ml-4">
            <div className="sticky top-6">
              <h2 className="text-xl font-bold mb-4 text-foreground hidden sm:flex">
                Latest Transactions
              </h2>
              <div className="flex sm:flex-col flex-row sm:space-x-0 space-y-0 space-x-3 sm:space-y-3 overflow-x-auto max-h-[calc(100vh-120px)] overflow-y-auto no-scrollbar">
                {transactions.length === 0 ? (
                  <Card className="p-4 text-center">
          ...
          {/* Main content stacked below on small, beside on md+ */}
          <main className=" sm:mt-11  flex-1 m-5">
            <div className="justify-center items-center">{children}</div>
          </main>
        </div>
      </div>

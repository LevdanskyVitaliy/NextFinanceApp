...
//           Showing {tableData.transactions.length} of {tableData.totalItems} transactions
//         </div>
//         <div className="flex items-center gap-2">
//           <Button 
...
//           </Button>
//           <div className="flex items-center space-x-1">
//             {Array.from({ length: Math.min(tableData.totalPages, 5) }, (_, i) => {
...
function CreateTransaction() {
    const { categories, addTransaction } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$app$2f$contexts$2f$TransactionContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTransactions"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            // Add the new transaction to context - this will automatically refresh the table
            if (result.data) {
...
//# sourceMappingURL=my-app_e622b21c._.js.map
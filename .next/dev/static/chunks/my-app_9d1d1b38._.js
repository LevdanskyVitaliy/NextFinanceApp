...
function EditTransactionPage({ params }) {
    ...
    const [transaction, setTransaction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
            ...
            async function fetchData() {
                try {
                    ...
                    const tx = transactions.find({
                        "EditTransactionPage.useEffect.fetchData.tx": (t)=>String(t.id) === id
                    }["EditTransactionPage.useEffect.fetchData.tx"]);
                    if (!tx) {
    ...
    if (error) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(EditTransactionPage, "kuBcayAMnAFAeI6TkC7dy7/G5O0=", false, function() {
    return [
...
//# sourceMappingURL=my-app_9d1d1b38._.js.map